...
CREATE OR REPLACE TABLE SNAPSHOTS.SNAP_CUSTOMERS (
    DBT_SCD_ID           VARCHAR,
...
CREATE OR REPLACE TABLE SNAPSHOTS.SNAP_PRODUCTS (
    DBT_SCD_ID       VARCHAR,
    DBT_UPDATED_AT   TIMESTAMP,
    DBT_VALID_FROM   TIMESTAMP,
    DBT_VALID_TO     TIMESTAMP,
...
CREATE OR REPLACE TABLE SALES_MART.CUSTOMER_LIFETIME_VALUE (
    CUSTOMER_ID           NUMBER,
    FIRST_NAME            VARCHAR,
    LAST_NAME             VARCHAR,
    EMAIL                 VARCHAR,
...
CREATE OR REPLACE TABLE SALES_MART.SALES_PERFORMANCE (
    ORDER_DATE          DATE,
    CATEGORY            VARCHAR,
    SUB_CATEGORY        VARCHAR,
    BRAND               VARCHAR,
...
CREATE OR REPLACE TABLE MARKETING_MART.CUSTOMER_ACQUISITION (
    ACQUISITION_CHANNEL   VARCHAR,
...
CREATE OR REPLACE TABLE MARKETING_MART.CUSTOMER_RFM_SEGMENTATION (
    CUSTOMER_ID           NUMBER,
    EMAIL                 VARCHAR,
    ACQUISITION_CHANNEL   VARCHAR,
    COUNTRY               VARCHAR,
